...
qmax=0.6
dir='C:/Users/mrinalkb/Documents/Collaborations/Ankit/'
##For reading experimental data file#
##----------------------------------#
fname='s126_s130_MDX1338_2.5 mgml+PS80_3.00CMC_rrf.txt'
...
print(data)
mif=NN_XR(data,rho_b=rho_b,beta_b=[0,1e-7],d=d,Nl=N,rho=rho,beta=beta,rho_range=rho_range,lamda=1.24,delta=delta/10,logy=0,Rf=1,iplot=1)
...
# mif.delta=0.1
# mif.evolve(qmax=qmax,iplot=1,iprint=1,deltam=0.01,avg=3)
# x=mif.x
# y=mif.y
# yerr=mif.y_err
# #z=mif.z
